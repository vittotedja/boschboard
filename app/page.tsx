...
import { AlertCircle, CheckCircle, Clock, PenToolIcon as Tool, AlertTriangle } from "lucide-react"
  ...
  return (
    <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
      <div className="flex items-center justify-between">
        <h2 className="text-3xl font-bold tracking-tight text-sky-950">Dashboard</h2>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card className="border-sky-250">
          <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
            <CardTitle className="text-sm font-medium text-sky-950">Total Tools</CardTitle>
        ...
        <Card className="border-red-600">
          <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
            <CardTitle className="text-sm font-medium text-red-600">Needs Calibration</CardTitle>
        ...
        <Card className="border-sky-250">
          <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
            <CardTitle className="text-sm font-medium text-sky-950">Calibrated</CardTitle>
        ...
        <Card className="border-sky-250">
          <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
            <CardTitle className="text-sm font-medium text-sky-950">Average Error</CardTitle>
          ...
          <CardContent>
            <ResponsiveContainer width="100%" height={300}>
              <LineChart data={errorTrendData}>
                <XAxis dataKey="month" />
                <YAxis />
                <Line type="monotone" dataKey="error" stroke="hsl(0 72% 51%)" strokeWidth={2} />
              </LineChart>
            </ResponsiveContainer>
          </CardContent>
        </Card>
