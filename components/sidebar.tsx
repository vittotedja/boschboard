...
import {Calendar, Menu, LayoutDashboard, ShieldAlert, X} from "lucide-react";
...
export const Sidebar: React.FC = () => {
	...
	return (
		<div
			className={`relative ${
				isOpen ? "w-64" : "w-24"
			} h-screen top-0 sticky bg-gray-100 text-white transition-all`}
		>
			<motion.div
			...
			>
				<div className="flex justify-between align-middle items-center p-4">
					...
					<button
						...
						className="text-gray-900 items-center"
					>
